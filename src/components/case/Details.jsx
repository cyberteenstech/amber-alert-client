...
const translations = {
  ...
  bn: {
    ...
    shareError:
      "শেয়ার করতে সমস্যা হচ্ছে। আপনার ব্রাউজার এই ফিচারটি সমর্থন নাও করতে পারে।",
            ...
            <div className="flex-1 space-y-8">
              <div className="grid gap-4 sm:grid-cols-2">
                <InfoItem
                  ...
                  label={t.age}
                  value={`${child.age} ${language === "bn" ? "বছর" : "years"}`}
                />
                <InfoItem
                  icon={<User className="h-5 w-5" />}
                  label="Gender"
