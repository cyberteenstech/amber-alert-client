                ...
                <div className="p-6 md:p-10 relative mt-8 rounded-xl bg-transparent">
                    ...
                    >
                        <div className="bg-transparent md:py-[48px] md:px-[44px] p-[20px]">
                            {/* Content */}
                            <p className="text-[#072E75] text-base md:text-lg mb-4 font-medium">
                                প্রিয়সম্মানিত নীতি-নির্ধারক,
                            </p>
                            <p className="text-[#072E75] text-base md:text-lg mb-4">
                            ...
                            <ol className="text-[#072E75] text-base md:text-lg mb-4">
